...
import com.ducnv1106.sell.databinding.FragmentMotobikeBinding
...
class MotoBikeFragment : BaseFragment<FragmentMotobikeBinding>() {

    private val adapter by lazy {
        com.ducnv1106.sell.adapter.BaseAdapter<Product>(
            context!!,
            R.layout.item_home
        )
    }

    override fun layoutId(): Int = R.layout.fragment_motobike

    override fun getTitle(): String = "Motobike"
    ...
    private fun requestApi() {
        ApiBuilder.service.getCar(Constants.ID_MOTOBIKE).subscribeOn(Schedulers.io())
